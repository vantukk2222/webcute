...
const messages = [
  {msg: "A biết rằng em đang làm việc vất vả, a chỉ muốn em biết rằng a luôn ở bên em, ủng hộ và yêu thương em.", title:"Tiếp nè!"},
  {msg: "Mỗi ngày xa em, a đều nhớ và trân trọng những khoảnh khắc bên nhau. Hãy luôn giữ gìn sức khỏe, em nhé!", title: "Nhớ em nhiều lắm"},
  {msg: "Em đã phải chịu nhiều mệt mỏi rồi, a biết rằng a không tốt, a vụng về khi làm thêm áp lực.", title: "Xin lỗi em iu"},
  {msg: "A xin lỗi vì đã làm em buồn. A không bao giờ muốn điều đó xảy ra, vì em là người a yêu thương nhất.", title:"Hãy cho a thêm cơ hội nhé"},
  {msg: "Nhân ngày 8/3, a muốn gửi đến em những điều tuyệt vời nhất. Em không chỉ là người a yêu, mà còn là nguồn động viên lớn nhất trong cuộc đời a.", title: "8/3 thật ngọt ngào"},
  {msg: "Dù xa nhau, nhưng trái tim a luôn hướng về em. Chúc em một ngày 8/3 thật vui vẻ và ngập tràn hạnh phúc!", title: "Chúc mừng ngày 8/3 em nhé"},
  {msg: "Nụ cười của em là điều quý giá nhất đối với a, a mong em luôn vui vẻ và hạnh phúc dù ở bất cứ đâu.", title : "Hãy luôn vui vẻ nhé"},
  {msg: "A mong rằng, em sẽ cho a thêm cơ hội để a được yêu thương em hơn nữa. A yêu em! Cô gái a iu.", title: "Bấm vào đây nè"}
];
